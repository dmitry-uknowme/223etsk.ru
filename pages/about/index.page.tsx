...
const reqData = [
  ...
  },
  {
    ...
    value: "8-800-234-12-25",
    // value: "+7 (919) 150-09-26",
...
const AboutPage = () => {
  const { data: documentsData } = useQuery("documents", async () => {
    const { data } = await axios.get(
      `https://lk.novorostorgi.ru/api/documents`
    );
              ...
              <Card>
                ...
                <Card.Body>
                  <div className="d-flex flex-wrap">
                    ...
                    <table
                      className="table-responsive table-bordered mt-3 tender_list"
                      style={{ marginLeft: "1rem" }}
                    >
                      <tbody>
                        {reqData.map(({ label, value }) => (
                          <tr>
                            <td
