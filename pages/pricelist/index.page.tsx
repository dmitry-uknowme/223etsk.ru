                            ...
                            <Card style={{ height: '100%' }}>
                                ...
                                <Card.Body>
                                    ...
                                    >
                                        ...
                                        <p>
                                            Комиссия с победителя <b>2%</b> от объявленной суммы торгов, начальная (максимальная) цена закупки которых составляет более 50 000,00 ₽.
                                        </p>
                                        <p>
                                            Комиссия с победителя <b>1.2%</b> от объявленной суммы торгов, начальная (максимальная) цена закупки которых составляет более 10 000 000,00 ₽.
                                        </p>
                                        <p>
                                            Комиссия с победителя <b>0.7%</b> от объявленной суммы торгов, начальная (максимальная) цена закупки которых составляет более 50 000 000,00 ₽.
                                        </p>
                                        <p>Комиссия с победителя <b>0.5%</b> от объявленной суммы торгов, начальная (максимальная) цена закупки которых составляет более 100 000 000,00 ₽.</p>
                                        <p>
